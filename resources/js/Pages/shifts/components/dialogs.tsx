...
export function Dialogs<TData>({
    ...
    const getWarningMessage = () => {
        const baseMessage = currentRow?.selectedIds
            ...
            <div className="space-y-2">
                ...
                <div className="p-3 text-sm border rounded-lg bg-muted/50">
                    ...
                    <p className="mt-1 text-muted-foreground">
                        Menghapus shift akan secara otomatis menghapus:
                    </p>
                    <ul className="mt-2 ml-4 space-y-1 list-disc text-muted-foreground">
                        <li>Semua jadwal yang terkait dengan shift ini</li>
                        <li>Semua presensi yang terkait dengan shift ini</li>
                        <li>Semua riwayat kehadiran yang terkait dengan shift ini</li>
                    </ul>
                </div>
            </div>
        );
            ...
            {currentRow && (
                <>
                    ...
                    <ConfirmDialog
                        ...
                        desc={getWarningMessage()}
                        confirmText='Saya Mengerti, Hapus'
                    />
                </>
            )}
        </>
