...
interface ContextType {
    ...
    currentRow: Major | null
    setCurrentRow: React.Dispatch<React.SetStateAction<Major | null>>
    resourceName: string
    mainRoute: string
...
export default function Provider({ children }: Props) {
    const resourceName = 'Jurusan'
    const mainRoute = 'majors'
    const [open, setOpen] = useDialogState<DialogType>(null)
    const [currentRow, setCurrentRow] = useState<Major | null>(null)
