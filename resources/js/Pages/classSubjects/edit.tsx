                ...
                <div className="peer-[.header-fixed]/header:mt-16 h-[calc(100vh-64px)] border-t overflow-hidden">
                    <DragDropContext onDragEnd={handleDragEnd}>
                        <div className="relative flex h-full">
                            ...
                            <div
                                className={`h-full bg-background border-r z-30 transition-all duration-300 overflow-hidden ${
                                    isOpen ? 'w-[300px]' : 'w-0'
                                }`}
                            >
                            ...
                            {/* Main Content */}
                            <div className={`z-20 flex flex-col flex-1 min-w-0 bg-background ${
                                isOpen ? '' : ''
                            }`}>
                                {/* Navigation Header - Fixed */}
                                <header className="flex items-center gap-2 p-4 border-b bg-background">
                                    <SubjectListSidebarTrigger />
