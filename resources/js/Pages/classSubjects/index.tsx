...
import { ClassSubjectResponse } from './data/schema'
...
function Content({
    ...
    return (
        <div className='flex flex-wrap items-center justify-between mb-2 space-y-2 gap-x-4'>
            ...
            <PrimaryButtons data={data} classrooms={classrooms}/>
        </div>
    )
}

function Index() {
    const { groupedClassSubjects, classrooms } = usePage<ClassSubjectResponse>().props
