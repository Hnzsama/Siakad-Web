...
interface ContextType {
    ...
    currentRow: WarningCategory | null
    setCurrentRow: React.Dispatch<React.SetStateAction<WarningCategory | null>>
    resourceName: string
    mainRoute: string
...
export default function Provider({ children }: Props) {
    const resourceName = 'Kategori Peringatan'
    const mainRoute = 'warningCategories'
    const [open, setOpen] = useDialogState<DialogType>(null)
    const [currentRow, setCurrentRow] = useState<WarningCategory | null>(null)
