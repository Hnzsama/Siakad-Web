...
import { StudentHistoryResponse } from './data/schema'
...
function Index() {
    const { studentHistories } = usePage<StudentHistoryResponse>().props
    const [tableInstance, setTableInstance] = React.useState<any>(null);

    return (
        <Provider>
            <Head title="Riwayat Siswa" />
            <Header fixed>
                <Search />
