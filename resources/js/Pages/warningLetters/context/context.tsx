...
interface ContextType {
    ...
    currentRow: WarningLetter | null
    setCurrentRow: React.Dispatch<React.SetStateAction<WarningLetter | null>>
    resourceName: string
    mainRoute: string
...
export default function Provider({ children }: Props) {
    const resourceName = 'Surat Peringatan'
    const mainRoute = 'warningLetters'
    const [open, setOpen] = useDialogState<DialogType>(null)
    const [currentRow, setCurrentRow] = useState<WarningLetter | null>(null)
