...
interface ContextType {
    ...
    currentRow: ViolationType | null
    setCurrentRow: React.Dispatch<React.SetStateAction<ViolationType | null>>
    resourceName: string
    mainRoute: string
...
export default function Provider({ children }: Props) {
    const resourceName = 'Jenis Pelanggaran'
    const mainRoute = 'violationTypes'
    const [open, setOpen] = useDialogState<DialogType>(null)
    const [currentRow, setCurrentRow] = useState<ViolationType | null>(null)
